...
-----------------------------------*/
  ...
  // Skip binding when React SiteHeader manages the offcanvas (React attaches
  // internal __reactFiber$ / __reactProps$ keys on managed DOM nodes).
  var reactManaged = offcanvasToggle && Object.keys(offcanvasToggle).some(function(k) {
    return k.indexOf('__reactFiber$') === 0 || k.indexOf('__reactProps$') === 0;
  });

  if (!reactManaged && offcanvasToggle && offcanvas) {
